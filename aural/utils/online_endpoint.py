...
class OnlineEndpointConfig:
    ...
    def from_args(args: dict) -> "OnlineEndpointConfig":
        ...
        rule1 = OnlineEndpointRule(
            must_contain_nonsilence=args["endpoint_rule1_must_contain_nonsilence"],
        ...
        rule2 = OnlineEndpointRule(
            must_contain_nonsilence=args["endpoint_rule2_must_contain_nonsilence"],
        ...
        rule3 = OnlineEndpointRule(
            must_contain_nonsilence=args["endpoint_rule3_must_contain_nonsilence"],
